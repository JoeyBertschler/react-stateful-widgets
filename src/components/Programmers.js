...
export default function Programmers() {
  ...
  let [featProgrammer, setFeatProgrammer] = useState(null); // why 0 work same?
  ...
  const getNameOfFeatured = () => {
    ...
    return programmerName[featProgrammer - 1].name
  };
      ...
      <div id='featured' style={style}>
        {
          ...
          // Replace the hard-coded false with the correct variable.  below: interpolate
          featProgrammer
