...
export default function Squares() {
  ...
  let [squares] = useState(listOfSquareIds) //you can ommit setX
  ...
  const markActive = id => {
    ...
    activeSquare == id ? setActiveSquare(null) : setActiveSquare(id); //this part broken? ===
  };
      ...
      <div className='squares'>
        {
          ...
          squares.map(id =>
            <div
              id={id}
              key={id}
              className={`square${getClassName(id)}`} // how affect state
